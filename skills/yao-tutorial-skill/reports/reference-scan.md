...
- The workspace already contains `docx`, `pdf`, `kami`, and page-generation skills. This skill should orchestrate document export and visual generation without becoming a full layout engine.
...
- The new skill should be routeable separately from generic learning-guide work because it emphasizes arbitrary-topic research breadth, visual HTML generation, and full publishing artifacts.
